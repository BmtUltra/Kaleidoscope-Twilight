...
public class KTBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<NormalUmbralSunflowerTrophyBlockEntity>> UMBRAL_SUNFLOWER_TROPHY =
            BLOCK_ENTITIES.register("umbral_sunflower_trophy", () ->
                    BlockEntityType.Builder.of(NormalUmbralSunflowerTrophyBlockEntity::new,
                            KTBlocks.UMBRAL_SUNFLOWER_TROPHY.get()).build(null));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<WallUmbralSunflowerTrophyBlockEntity>> WALL_UMBRAL_SUNFLOWER_TROPHY =
