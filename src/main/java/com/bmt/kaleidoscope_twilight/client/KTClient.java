...
import com.bmt.kaleidoscope_twilight.client.render.UmbralSunflowerRenderer;
...
public class KTClient {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> EntityRenderers.register(KTEntities.UMBRAL_SUNFLOWER.get(), UmbralSunflowerRenderer::new));
