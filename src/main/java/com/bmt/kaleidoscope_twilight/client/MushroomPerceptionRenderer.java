...
@OnlyIn(Dist.CLIENT)
@Mod.EventBusSubscriber(modid = "kaleidoscope_twilight", value = Dist.CLIENT)
public class MushroomPerceptionRenderer {
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent event) {
        ...
        if (!mc.player.hasEffect(KTEffects.MUSHROOM_PERCEPTION.get())) {
            return;
        }

        var effectInstance = mc.player.getEffect(KTEffects.MUSHROOM_PERCEPTION.get());
